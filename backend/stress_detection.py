...
class StressDetectionAPI:
    ...
    def process_image(self, image_path, user_id):
        ...
        # Simulate ML model processing with more realistic ranges
        # IT professionals typically have higher stress (65-95%)
        # This is a simulation - a real model would analyze facial features, heart rate, etc.
        ...
        try:
            ...
            # In a real application, the model would analyze the face
            # For this demo, we'll generate a stress score that's realistic
            # IT professionals tend to have higher stress levels
            ...
            # Generate stress score based on user profile
            # Simulate more realistic stress levels (higher for IT professionals)
            base_stress = 65  # Base stress level for IT professionals
